...
function generateCat() {
    ...
    let focus = document.getElementById('flex-cat-gen');
...
const hitSound = new Audio('static/media/swish.m4a');
const winSound = new Audio('static/media/cash.mp3');
const lossSound = new Audio('static/media/aww.mp3');

document.querySelector('#blackjack-hit-button').addEventListener('click', blackjackHIT);
document.querySelector('#blackjack-stand-button').addEventListener('click', stand);
document.querySelector('#blackjack-nextHand-button').addEventListener('click', blackjackNextHand);
